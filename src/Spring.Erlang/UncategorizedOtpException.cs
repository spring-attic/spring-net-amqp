// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UncategorizedOtpException.cs" company="The original author or authors.">
...
namespace Spring.Erlang
{
    ...
    {
        /// <summary>Initializes a new instance of the <see cref="UncategorizedOtpException"/> class.</summary>
