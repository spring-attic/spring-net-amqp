// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FanoutExchange.cs" company="The original author or authors.">
...
namespace Spring.Messaging.Amqp.Core
{
    ...
    {
        /// <summary>Initializes a new instance of the <see cref="FanoutExchange"/> class.</summary>
        ...
        /// Gets Type.
        /// </summary>
        public override string Type { get { return ExchangeTypes.Fanout; } }
    }
}
