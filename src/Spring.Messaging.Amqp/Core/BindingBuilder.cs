// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BindingBuilder.cs" company="">
//   
// </copyright>
// <summary>
//   The binding builder 2.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Spring.Messaging.Amqp.Core
{
    ...
    public sealed class BindingBuilder
    {
        ...
        {
            return new DestinationConfigurer(queue.Name, Binding.DestinationType.Queue);
        }
        ...
        {
            return new DestinationConfigurer(exchange.Name, Binding.DestinationType.Exchange);
        }
        ...
        public abstract class AbstractRoutingKeyConfigurer<T> where T : IExchange
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="AbstractRoutingKeyConfigurer{T}"/> class. 
            /// Initializes a new instance of the <see cref="AbstractRoutingKeyConfigurer{E}"/> class.
            /// </summary>
        ...
        public class DestinationConfigurer
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="DestinationConfigurer"/> class.
            /// </summary>
            /// <param name="name">
            /// The name.
            /// </param>
            ...
            /// </summary>
            public Binding.DestinationType Type
            {
        ...
        {
            /// <summary>
            /// Initializes a new instance of the <see cref="DirectExchangeRoutingKeyConfigurer"/> class.
            /// </summary>
            /// <param name="destination">
            /// The destination.
            /// </param>
            ...
            {
                return new Binding(this.destination.Name, this.destination.Type, this.exchange, routingKey, null);
            }
            ...
            {
                return new Binding(this.destination.Name, this.destination.Type, this.exchange, routingKeyEnum.ToString(), null);
            }
            ...
            {
                return new Binding(this.destination.Name, this.destination.Type, this.exchange, this.destination.Name, null);
            }
        }
        ...
        public class GenericArgumentsConfigurer
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="GenericArgumentsConfigurer"/> class.
            /// </summary>
            ...
            /// The binding.
            /// </returns>
            public Binding And(IDictionary map)
            {
            ...
            {
                return new Binding(this.configurer.destination.Name, this.configurer.destination.Type, this.configurer.exchange, this.routingKey, null);
            }
        }
        ...
        {
            /// <summary>
            /// Initializes a new instance of the <see cref="GenericExchangeRoutingKeyConfigurer"/> class.
            /// </summary>
            /// <param name="destination">
            /// The destination.
            /// </param>
        ...
        public class HeadersExchangeMapConfigurer
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="HeadersExchangeMapConfigurer"/> class.
            /// </summary>
            /// <param name="destination">
            /// The destination.
            /// </param>
            ...
            {
                return new HeadersExchangeSingleValueBindingCreator(this.destination, this.exchange, key);
            }
            ...
            {
                return new HeadersExchangeKeysBindingCreator(this.destination, this.exchange, headerKeys, false);
            }
            ...
            /// The headers exchange map binding creator.
            /// </returns>
            public HeadersExchangeMapBindingCreator WhereAny(IDictionary headerValues)
            {
                return new HeadersExchangeMapBindingCreator(this.destination, this.exchange, headerValues, false);
            }
            ...
            {
                return new HeadersExchangeKeysBindingCreator(this.destination, this.exchange, headerKeys, true);
            }
            ...
            /// The headers exchange map binding creator.
            /// </returns>
            public HeadersExchangeMapBindingCreator WhereAll(IDictionary headerValues)
            {
                return new HeadersExchangeMapBindingCreator(this.destination, this.exchange, headerValues, true);
            }
            ...
            public class HeadersExchangeKeysBindingCreator
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="HeadersExchangeKeysBindingCreator"/> class.
                /// </summary>
                /// <param name="destination">
                /// The destination.
                /// </param>
                ...
                {
                    return new Binding(this.destination.Name, this.destination.Type, this.exchange.Name, string.Empty, this.headerMap);
                }
            }
            ...
            public class HeadersExchangeMapBindingCreator
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="HeadersExchangeMapBindingCreator"/> class.
                /// </summary>
                /// <param name="destination">
                /// The Destination.
                /// </param>
            ...
            public class HeadersExchangeSingleValueBindingCreator
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="HeadersExchangeSingleValueBindingCreator"/> class.
                /// </summary>
                /// <param name="destination">
                /// The destination.
                /// </param>
                ...
                {
                    return new Binding(this.destination.Name, this.destination.Type, this.exchange.Name, string.Empty, CreateMapForKeys(this.key));
                }
        ...
        {
            /// <summary>
            /// Initializes a new instance of the <see cref="TopicExchangeRoutingKeyConfigurer"/> class.
            /// </summary>
            /// <param name="destination">
            /// The destination.
            /// </param>
            ...
            public Binding With(string routingKey)
            {
                return new Binding(destination.Name, destination.Type, exchange, routingKey, null);
            }
            ...
            public Binding With(Enum routingKeyEnum)
            {
                return new Binding(destination.Name, destination.Type, exchange, routingKeyEnum.ToString(), null);
            }
        }
