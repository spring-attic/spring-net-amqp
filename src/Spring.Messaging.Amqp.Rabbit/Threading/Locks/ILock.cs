// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ILock.cs" company="The original author or authors.">
...
namespace Spring.Threading.Locks
{
    ...
    public interface ILock
    {
        ...
        /// </remark>
        /// <param name="timeSpan">
        /// The specificed <see cref="System.TimeSpan"/> to wait to aquire lock.</param>
        /// <returns><c>true</c> if the lock was acquired and <c>false</c> if the
        /// waiting time elapsed before the lock was acquired.</returns>
        /// <exception cref="ThreadInterruptedException">If the current thread is interrupted while aquirign the lock (and
        /// interruption of lock acquisition is supported).</exception>
        /// <seealso cref="Thread.Interrupt()"/>
