// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AtomicBoolean.cs" company="The original author or authors.">
...
namespace Spring.Threading.AtomicTypes
{
    ...
    public class AtomicBoolean : IAtomic<bool>
    {
        // JDK_1_6
        /// <summary>
        /// Holds a <see cref="int"/> representation of the flag value.
        /// </summary>
        private volatile int _booleanValue;

        /// <summary>Initializes a new instance of the <see cref="AtomicBoolean"/> class. 
        /// Creates a new <see cref="AtomicBoolean"/> with the given initial value.</summary>
        /// <param name="initialValue">The initial value</param>
        public AtomicBoolean(bool initialValue) { this._booleanValue = initialValue ? 1 : 0; }

        /// <summary>Initializes a new instance of the <see cref="AtomicBoolean"/> class.  
        /// Creates a new <see cref="AtomicBoolean"/> with initial value of <c>false</c>.</summary>
        ...
        {
            int u = newValue ? 1 : 0;
            return Interlocked.Exchange(ref this._booleanValue, u) == 1;
        }
        ...
        /// </returns>
        public static implicit operator bool(AtomicBoolean atomicBoolean) { return atomicBoolean.Value; }
    }
}
