// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AbstractCollection.cs" company="The original author or authors.">
...
{
    /// <summary>Serve as based class to be inherited by the classes that needs to
    /// implement both the <see cref="ICollection"/> and 
    /// the <see cref="ICollection{T}"/> interfaces.</summary>
    /// <remarks><para>By inheriting from this abstract class, subclass is only required
    /// to implement the <see cref="GetEnumerator()"/> to complete a concrete
    /// read only collection class.</para>
    /// <para><see cref="AbstractCollection{T}"/> throws <see cref="NotSupportedException"/> 
    /// for all access to the collection mutating members. </para>
    /// </remarks>
    ...
    public abstract class AbstractCollection<T> : ICollection<T>, ICollection
    {
        ...
        /// <summary>Adds an item to the <see cref="ICollection{T}"/>. This implementation
        /// always throw <see cref="NotSupportedException"/>.</summary>
        /// <param name="item">The object to add to the <see cref="ICollection{T}"/>.</param>
        /// <exception cref="NotSupportedException">The <see cref="ICollection{T}"/> is read-only. This implementation 
        /// always throw this exception.</exception>
        ...
        /// <summary>Determines whether the <see cref="ICollection{T}"/> contains a specific 
        /// value. This implementation searchs the element by iterating through the 
        /// enumerator returned by <see cref="GetEnumerator()"/> method.</summary>
        ...
        /// </returns>
        public virtual T[] ToArray() { return this.DoCopyTo(null, 0, true); }
        ...
        /// collection.
        /// 	</summary>
        /// <remarks><para>Like the <see cref="ToArray()"/> method, this method acts as bridge
        ...
        /// allocation costs.</para>
        /// <para>Suppose <i>x</i> is a collection known to contain only strings.
        /// The following code can be used to dump the collection into a newly
        /// allocated array of <see cref="string"/>s:
        /// <code language="c#">		string[] y = (string[]) x.ToArray(new string[0]);
        /// 	</code>
        /// </para>
        /// <para>Note that <i>ToArray(new T[0])</i> is identical in function to<see cref="AbstractCollection{T}.ToArray()"/>.</para>
        /// </remarks>
        /// <param name="targetArray">The array into which the elements of the colleciton are to be
        ...
        /// <exception cref="ArrayTypeMismatchException">If type of <paramref name="targetArray"/> is a derived type of<typeparamref name="T"/> and the collection contains element that
        /// is not that derived type.</exception>
        ...
        /// index.</summary>
        /// <remarks>This method is intentionally sealed. Subclass should override<see cref="DoCopyTo(T[], int, bool)"/> instead.</remarks>
        ...
        /// <summary>Does the actual work of copying to array. Subclass is recommended to 
        ...
        /// before calling this method.</summary>
        /// <param name="array">The one-dimensional <see cref="Array"/> that is the 
        /// destination of the elements copied from <see cref="ICollection{T}"/>. 
        /// The <see cref="Array"/> must have zero-based indexing.</param>
        /// <param name="arrayIndex">The zero-based index in array at which copying begins.</param>
        ...
        /// <remarks>If <typeparamref name="T"/> is <see cref="object"/> but array is 
        /// actaully <c>string[]</c>, the returned array is always <c>string[]</c>.</remarks>
        /// <param name="array">The source array.</param>
        /// <param name="length">Expected length of array.</param>
        /// <returns><paramref name="array"/> itself if <c>array.Length &gt;= length</c>. 
        /// Otherwise a new array of same type of <paramref name="array"/> of given<paramref name="length"/>.</returns>
        ...
        /// This implementation always throw <see cref="NotSupportedException"/>.</summary>
        /// <returns>true if item was successfully removed from the <see cref="ICollection{T}"/>; 
        /// otherwise, false. This method also returns false if item is not found in the 
        /// original <see cref="ICollection{T}"/>.</returns>
        /// <param name="item">The object to remove from the <see cref="ICollection{T}"/>.</param>
        /// <exception cref="NotSupportedException">When the <see cref="ICollection{T}"/> is read-only. This implementation always 
        ...
        /// <summary>Copies the elements of the <see cref="T:System.Collections.ICollection"></see> 
        /// to an <see cref="T:System.Array"></see>, starting at a particular <see cref="T:System.Array"></see> index.</summary>
        /// <param name="array">The one-dimensional <see cref="T:System.Array"></see> 
        /// that is the destination of the elements copied from <see cref="T:System.Collections.ICollection"></see>. The <see cref="T:System.Array"></see> must have zero-based indexing. </param>
        /// <param name="index">The zero-based index in array at which copying begins. </param>
        /// <exception cref="T:System.ArgumentNullException">array is null. </exception>
        /// <exception cref="T:System.ArgumentOutOfRangeException">index is less than zero. </exception>
        /// <exception cref="T:System.ArgumentException">array is multidimensional.-or- index is equal to or greater than 
        /// the length of array.-or- The number of elements in the source <see cref="T:System.Collections.ICollection"></see> is greater 
        /// than the available space from index to the end of the destination 
        /// array. </exception>
        /// <exception cref="T:System.InvalidCastException">The type of the source <see cref="T:System.Collections.ICollection"></see> 
        ...
        /// <summary>Copies the elements of the <see cref="ICollection"/> to an <see cref="Array"/>, starting at a particular <see cref="Array"/> 
        /// index.</summary>
        /// <param name="array">The one-dimensional <see cref="Array"/> that is the destination 
        /// of the elements copied from <see cref="ICollection"/>. The <see cref="Array"/> must have zero-based indexing. </param>
        /// <param name="index">The zero-based index in array at which copying begins. </param>
        /// <exception cref="ArgumentNullException">array is null. </exception>
        /// <exception cref="ArgumentOutOfRangeException">index is less than zero. </exception>
        /// <exception cref="ArgumentException">array is multidimensional.-or- index is equal to or greater than 
        /// the length of array.
        /// -or- 
        ...
        /// collection is modified while the operation is in progress.</para>
        /// <para>This implementation iterates over the specified collection, and 
        ...
        /// the associated exception is thrown.</para>
        /// </remarks>
        ...
        /// <summary>Called by <see cref="AddRange"/> after the parameter is validated
        /// to be neither <c>null</c> nor this collection itself.</summary>
