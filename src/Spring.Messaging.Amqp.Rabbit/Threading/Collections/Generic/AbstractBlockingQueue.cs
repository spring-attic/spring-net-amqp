// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AbstractBlockingQueue.cs" company="The original author or authors.">
...
{
    /// <summary>This class provides skeletal implementations of some<see cref="IBlockingQueue{T}"/> operations.</summary>
    ...
    public abstract class AbstractBlockingQueue<T> : AbstractQueue<T>, IBlockingQueue<T>
    {
        ...
        /// <exception cref="System.ArgumentNullException">If the specified collection is <see langword="null"/>.</exception>
        /// <exception cref="System.ArgumentException">If <paramref name="collection"/> represents the queue itself.</exception>
        /// <seealso cref="AbstractQueue{T}.Drain(System.Action{T})"/><seealso cref="DrainTo(ICollection{T},int)"/><seealso cref="AbstractQueue{T}.Drain(System.Action{T},int)"/>
        public virtual int DrainTo(ICollection<T> collection) { return this.DrainTo(collection, null); }
        ...
        /// <exception cref="System.ArgumentException">If <paramref name="collection"/> represents the queue itself.</exception>
        /// <seealso cref="IQueue{T}.Drain(System.Action{T})"/><seealso cref="IBlockingQueue{T}.DrainTo(System.Collections.Generic.ICollection{T},int)"/><seealso cref="IQueue{T}.Drain(System.Action{T},int)"/>
        ...
        /// <exception cref="System.ArgumentNullException">If the specified collection is <see langword="null"/>.</exception>
        /// <exception cref="System.ArgumentException">If <paramref name="collection"/> represents the queue itself.</exception>
        /// <seealso cref="DrainTo(ICollection{T})"/><seealso cref="AbstractQueue{T}.Drain(System.Action{T})"/><seealso cref="AbstractQueue{T}.Drain(System.Action{T},int)"/>
        public virtual int DrainTo(ICollection<T> collection, int maxElements) { return this.DrainTo(collection, maxElements, null); }
        ...
        /// <exception cref="System.ArgumentNullException">If the specified collection is <c>null</c>.</exception>
        /// <exception cref="System.ArgumentException">If <paramref name="collection"/> represents the queue itself.</exception>
        /// <seealso cref="IBlockingQueue{T}.DrainTo(System.Collections.Generic.ICollection{T})"/><seealso cref="IQueue{T}.Drain(System.Action{T})"/><seealso cref="IQueue{T}.Drain(System.Action{T},int)"/>
        ...
        protected override bool IsSynchronized { get { return true; } }
