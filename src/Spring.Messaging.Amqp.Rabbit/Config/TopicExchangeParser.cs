// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TopicExchangeParser.cs" company="The original author or authors.">
...
namespace Spring.Messaging.Amqp.Rabbit.Config
{
    ...
    public class TopicExchangeParser : AbstractExchangeParser
    {
        ...
        protected override Type GetObjectType(XmlElement element) { return typeof(TopicExchange); }
