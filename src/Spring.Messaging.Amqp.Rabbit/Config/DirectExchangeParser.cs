// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DirectExchangeParser.cs" company="The original author or authors.">
...
namespace Spring.Messaging.Amqp.Rabbit.Config
{
    ...
    public class DirectExchangeParser : AbstractExchangeParser
    {
        ...
        protected override Type GetObjectType(XmlElement element) { return typeof(DirectExchange); }
